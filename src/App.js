          ...
          <div className="text-center tm-hero-text-container">
            <div className="tm-hero-text-container-inner">
              ...
              <p className="tm-hero-subtitle">
                Collection of consulting work, experiences, and opinions on
                human interest.
              </p>
            </div>
          </div>
              ...
              <div className="col-lg-12 col-xl-12">
                <div className="tm-intro-text-container">
                  ...
                  <p className="mb-4 tm-intro-text">
                    Interst in works that influence my bigger picture for
            ...
            <div className="row tm-content-box">
              ...
              <div className="col-lg-5">
                <div className="tm-intro-text-container">
                  ...
                  <p className="mb-4 tm-intro-text">
                    Sewing and made-to-measure bespoke clothing, private fabric
                    boutique
                  </p>
                </div>
              </div>
            ...
            <div className="row tm-content-box">
              ...
              <div className="col-lg-5">
                <div className="tm-intro-text-container">
                  ...
                  <p className="mb-4 tm-intro-text">
                    Studies on vairous beliefs, and forms of worship
                    <strong>
                      {" "}
                      Christianity, Judaism, Greek, Sumarian, Kemetic Orthodoxy
                    </strong>
                    and the effect on the world economy, politics, moral fabric
                  </p>
                ...
                <div className="mx-auto tm-gallery-container tm-gallery-container-2">
                  <div className="tm-testimonials-carousel">
                    <figure className="tm-testimonial-item tm-image">
                      <img
                        src="img/testimonial-img-02.jpeg"
                        alt="testimonial"
